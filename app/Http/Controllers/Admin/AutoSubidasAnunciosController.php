...
class AutoSubidasAnunciosController extends Controller {
	...
	public function __construct()
    {
		...
		$profile = $search->get();
		 ...
		 return view('admin.auto_subidas_anuncios.index',['profile'=>$profile,'title'=>$title,'categories'=>$categories,'province'=>$provinceData]);
