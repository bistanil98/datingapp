...
class TopAnunciosController extends Controller {
	...
	public function __construct()
    {
		...
		$profile = $search->get();
		 ...
		 return view('admin.top_anuncios.index',['profile'=>$profile,'title'=>$title,'categories'=>$categories,'province'=>$provinceData]);
