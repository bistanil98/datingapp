...
class TopAnunciosAgencyController  extends Controller {
	...
	public function __construct()
    {
		...
		$search->where('top_subida_profile_lists.type', 'top');
		...
		$profile = $search->get();
		 ...
		 return view('admin.top_anuncios_agency.index',['profile'=>$profile,'title'=>$title,'categories'=>$categories,'province'=>$provinceData]);
		...
		$profile = $search->first();
			...
			return view('admin.top_anuncios.view',['data'=>$profile]);
		}
