...
$(function(e) {
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#564ec1', '#04cad0', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	/* ---hightchart4----*/
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#ecb403', '#24CBE5', '#04cad0', '#564ec1', '#ff5c75'],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	var chart = Highcharts.chart('highchart7', {
		...
		colors: ['#564ec1', '#04cad0', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
		series: [{
			type: 'column',
			colorByPoint: true,
