										...
										<div class="left-registration">
											<div class="main-image-register">
												<div class="top-cover-img">
													...
													<input  data-default-file="<?php if(!empty($profile_ads->profile_pic)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->profile_pic); }?>" type="file" name="profile" accept='image/*'  data-allowed-file-extensions="png jpg jpeg"  class="dropify">
												</div>
															...
															<div class="col-md-4 select-column">
																<select name="full_from_1[]" class="custom-select mb-3">
																	...
																	<?php foreach($schedule_from_1 as $data){ ?>
																		<option <?php if(json_decode($profile_ads->schedule,true)[0]['from_1']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																	<?php } ?>
																</select>
															</div>
															<div class="col-md-4 select-column">
																<select name="full_from_2[]" class="custom-select mb-3">
																	...
																	<?php foreach($schedule_from_2 as $data){ ?>
																		<option <?php if(json_decode($profile_ads->schedule,true)[0]['from_2']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																	<?php } ?>
																</select>
															</div>
														</div>  
														...
														<div class="row select-row">
															...
															<div class="col-md-4 select-column">
																<select name="full_unit_1[]" class="custom-select mb-3">
																	<option></option>
																	<?php foreach($schedule_from_1 as $data){ ?>
																		<option <?php if(json_decode($profile_ads->schedule,true)[0]['unit_1']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																	<?php } ?>
																</select>
															</div>
															<div class="col-md-4 select-column">
																<select name="full_unit_2[]" class="custom-select mb-3">
																	<option></option>
																	<?php foreach($schedule_from_2 as $data){ ?>
																		<option <?php if(json_decode($profile_ads->schedule,true)[0]['unit_2']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																	<?php } ?>
																</select>
															</div>
														</div>  
													...
													<div class="col-md-12 col-lg-8 col-sm-12">
														...
														<div class="row select-row">
															<div class="col-md-12 col-lg-4 col-6  col-sm-12 select-column label-column">
																<input <?php if($edit_schedule['days']==$data){ echo 'checked';}?> type="checkbox" value="{{$data}}" id="defaultCheck" name="days[]" style="vertical-align: middle;">
															...
															<div class="col-md-4 col-lg-2 col-6 col-sm-4 select-column2">
																<select name="from_1[]" class="custom-select cus-select mb-3">
																		<option></option>
																		<?php foreach($schedule_from_1 as $data){ ?>
																			<option <?php if($edit_schedule['from_1']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																		<?php } ?>
																	</select>
															</div>
															<div class="col-md-4 col-lg-2 col-6 col-sm-4 select-column2">
																<select name="from_2[]" class="custom-select cus-select mb-3">
																		<option></option>
																		<?php foreach($schedule_from_2 as $data){ ?>
																			<option <?php if($edit_schedule['from_2']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																		<?php } ?>
																	</select>
															</div>
														</div>  
														...
														<div class="row select-row">
															...
															<div class="col-md-4 col-lg-4 col-6 col-sm-4 select-column2">
																<select name="unit_1[]" class="custom-select cus-select mb-3">
																		<option></option>
																		<?php foreach($schedule_from_1 as $data){ ?>
																			<option <?php if($edit_schedule['unit_1']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																		<?php } ?>
																	</select>
															</div>
															<div class="col-md-4 col-lg-4 col-6 col-sm-4 select-column2">
																<select name="unit_2[]" class="custom-select cus-select mb-3">
																		<option></option>
																		<?php foreach($schedule_from_2 as $data){ ?>
																			<option <?php if($edit_schedule['unit_2']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																		<?php } ?>
																	</select>
															</div>
														</div>  
