...
<html lang="en">
                  ...
                  <ul id="services" class="sublist-ul">
				   <?php foreach(services() as $servicesData){?>
                     <li class="sublist-li firstcheckbox first_01">
                        <label><input type="checkbox" name="services[]" value="{{$servicesData->name}}" class="lesft-ab-check"> <span>{{$servicesData->name}}</span></label>                        
                     </li> 
					  <?php } ?>
               ...
               <li class="search-mainli">
                  ...
                  <ul class="sublist-ul tipo-ul">
                     <li class="sublist-li firstcheckbox">
                        <form><label><input type="checkbox" name="kind[]" value="Bike"> <span>Independiente
                           </span></label>
                        </form>
                     </li>
                     <li class="sublist-li firstcheckbox">
                        <form><label><input type="checkbox" name="kind[]" value="Bike"> <span>De agencia</span></label>
                        </form>
                     </li>
                     <li class="sublist-li firstcheckbox">
                        <form><label><input type="checkbox" name="kind[]" value="Bike"> <span>Anuncios con videos
                           </span></label>
                        </form>
                     </li>
                     <li class="sublist-li firstcheckbox">
                        <form><label><input type="checkbox" name="kind[]" value="Bike"> <span>Perfil verificado
                           </span></label>
                        </form>
                     </li>
               ...
               <li class="search-mainli">
                  ...
                  <ul class="sublist-ul horiyo-ul apariencia-ul">
                     <li class="sublist-li horiyo-price range-price">
                        ...
                        <div class="input-range">
                           <input type="text" readonly   id="min-slider-age" value="min_age" class="price-range-field left" />
                           <input type="text" readonly   id="max-slider-age" value="max_age" class="price-range-field right" />
                        </div>
                     </li>
                     <li class="sublist-li horiyo-price range-price">
                        ...
                        <div class="input-range">
                           <input type="text" readonly value="min_height"  id="min-slider-height" class="price-range-field left" />
                           <input type="text" readonly value="max_height"  id="max-slider-height" class="price-range-field right" />
                        </div>
                     </li>
                     <li class="sublist-li horiyo-price range-price">
                        ...
                        <div class="input-range">
                           <input type="text" readonly value="min_weight"   id="min-slider-weight" class="price-range-field left" />
                           <input type="text" readonly value="max_weight"  id="max-slider-weight" class="price-range-field right" />
                        </div>
                     </li>
               ...
               <li class="search-mainli">
                  ...
                  <ul class="sublist-ul horiyo-ul last-price">
                     <li class="sublist-li horiyo-price range-price">
                        ...
                        <div class="input-range">
                           <input type="text" readonly  value="min_tariffs"   id="min-slider-tarifas" class="price-range-field left last" />
                           <input type="text" readonly value="min_tariffs"   oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" id="max-slider-tarifas" class="price-range-field right" />
                        </div>
                     </li>
                  </ul>
               </li>
   ...
   <!-- row -->
											...
											success: function( response ) {		
											$('.main-pop-sec .modal-content').html(response);		
											},		
...
<script>
	//nationalitycountries
		...
		$('#services li input').on('click', function(){		 
		 $('#searchResult').empty();
		 search();
		});
