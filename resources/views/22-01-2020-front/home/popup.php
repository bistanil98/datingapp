				...
				<div class="modal fade show" id="girl_modals<?php echo $data->id;?>">
					...
					<div class="modal-dialog main-popup modal-xl">
						...
						<?php if(!empty($top_previous_profile)){?>
							<button data-id="<?php echo $top_previous_profile ;?>"  class="btn btn-danger left"><i class="fas fa-arrow-left"></i> </button>
						<?php } ?>
						<?php if(!empty($top_next_profile)){?>
						<button data-id="<?php echo $top_next_profile ;?>" class="btn btn-danger right"><i class="fas fa-arrow-right"></i> </button>
						<?php } ?>
					</div> 
									...
									<div class="col-md-6">
										<div class="right-main-popup">
											<div class="girl-detais-div common-div">
												<h3><?php echo $data->first_name ;?>  |  <?php echo $data->telephone ;?></h3>
												...
												<div class="main-justify-div">
													...
													<div class="justify-girl-detais"><h5>Estatura </h5> <span class="name2"><?php echo $data->height ;?></span></div>
												</div>
												<div class="main-justify-div">
													<div class="justify-girl-detais second-justi"><h5> Peso</h5> <span class="name2"><?php echo $data->weight ;?></span></div>
													<div class="justify-girl-detais second-justi"><h5>Pecho</h5> <span class="name2"><?php echo $data->chest ;?></span></div>
												</div>
												<div class="main-justify-div">
												...
												<div class="contact-link"><a href="#" class="btn btn-primary"><i class="fas fa-phone-alt"></i> <span><?php echo $data->telephone ;?></span></a>
