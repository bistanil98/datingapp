...
<button data-id="{{$top_previous_profile}}"  class="btn btn-danger left arrow-left"><i class="fas fa-arrow-left"></i> </button>
<?php } ?>
<?php if(!empty($top_next_profile)){?>
<button data-id="{{$top_next_profile}}" class="btn btn-danger right arrow-right"><i class="fas fa-arrow-right"></i> </button>
<?php } ?>
					</div> 
									...
									<div class="col-md-6">
										<div class="right-main-popup">
											<div class="girl-detais-div common-div">
												...
												<h3><span style="color:#fff">Name</span> <?php echo ucwords($data->first_name) ;?> </h3>
												...
												<div class="main-justify-div">
													<div class="justify-girl-detais second-justi"><h5> Peso</h5> <span class="name2">{{$data->weight}} kg</span></div>
...
$('.arrow-right').click(function() {
   //window.history.pushState('obj', 'PageTitle', '/NewPage');   
   	$.ajaxSetup({
		...
		var profile_id = '<?php echo $top_next_profile;?>';
...
$('.arrow-left').click(function() {
   //window.history.pushState('obj', 'PageTitle', '/NewPage');   
   	$.ajaxSetup({
		...
		var profile_id = '<?php echo $top_previous_profile;?>';
