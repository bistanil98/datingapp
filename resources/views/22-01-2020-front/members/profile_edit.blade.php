												...
												<div class="row">
													<div class="form-group col-md-4">
														...
														<?php foreach($categories as $data){?>
															<option <?php if(strtolower($data->name)==$profile_ads->category){ echo 'selected'; }?> value="{{strtolower($data->name)}}">{{$data->name}}</option>
															<?php }?>
														</select>
													</div>
												</div>
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														...
														<select name="height" class="custom-select" required>
															...
															<option <?php if($height==$profile_ads->height){ echo 'selected'; }?> value='{{$height}}'>{{$height}} cm</option>
															<?php } ?>
