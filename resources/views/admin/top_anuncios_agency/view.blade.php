...
<div class="container content-area relative">
	...
	<div class="page-header">
		<h4 class="page-title">Top Anuncios</h4>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Home</a></li>
			<li class="breadcrumb-item"><a href="{{ url('/admin/top_anuncios') }}">Top Anuncios</a></li>                                
											...
											<div class="col-lg-6 col-md-12">
												<div class="wideget-user-desc d-flex">
													...
													<div class="user-wrap">
														...
														<a class="btn btn-primary mt-1 mb-1" href="{{ url('/admin/top_anuncios/index') }}"><i class="fa fa-arrow-left"></i> Back</a> 
