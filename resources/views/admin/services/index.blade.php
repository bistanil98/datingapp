						...
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									...
									<a href="{{ url('/admin/services/add') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add New</a> 
								</div>
								<div class="card-body">
										...
										<table id="examples1" class="table table-striped table-bordered text-nowrap w-100">
											...
											<tbody>
												...
												<tr>
													...
													<td>													
													<a  data-toggle="tooltip" data-original-title="Edit" class="btn btn-sm btn-primary" href="{{url('/admin/services/edit/')}}/{{$data->id}}" ><i class="fa fa-edit"></i> Edit</a>							
													<a  data-id="{{$data->id}}"  data-location="services"    href="#" data-toggle="tooltip" data-original-title="Delete" class="btn btn-sm btn-danger sa-params"  ><i class="fa fa-trash"></i> Delete</a>
													</td>
												</tr>
												@endforeach												
											</tbody>
