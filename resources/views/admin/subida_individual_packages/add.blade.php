				   ...
				   <!-- PAGE-HEADER -->
					<div class="page-header">
						...
						<ol class="breadcrumb">
							 ...
							 <li class="breadcrumb-item"><a href="{{ url('/admin/subida-individual-packages') }}">Top individual Packages</a></li>                                
					...
					<!-- ROW-1 OPEN -->
						...
						<div class="row">
					<div class="col-lg-12">
							 <form action="{{ action('Admin\SubidaIndividualPackagesController@add')}}" enctype="multipart/form-data" method="post" class="card">
								@csrf							
								<div class="card-header">
									<h3 class="card-title">Add Subida Individual Packages</h3>
								</div>
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required value="{{ old('subidas') }}" type="text" name="subidas" class="form-control">
