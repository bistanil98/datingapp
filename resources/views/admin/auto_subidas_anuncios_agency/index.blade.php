				...
				<div class="container content-area relative">
				   ...
				   <!-- PAGE-HEADER -->
					<div class="page-header">
						<h1 class="page-title">Auto Subida agency</h1>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">Members</a></li>
							<li class="breadcrumb-item active" aria-current="page">Auto Subida agency</li>
						</ol>
					</div>
					<!-- PAGE-HEADER END -->
					...
					<div class="row">
						<div class="col-md-12 col-lg-12">						
							 ...
							 <style> .card-header { display: block;padding: 1rem 0.5rem 0rem 2rem;}</style>
								...
								<form  action="{{url('/admin/auto_subidas_anuncios_agency/index')}}" enctype="multipart/form-data" method="get" >								
									...
									<div class="table-responsive">
										<table id="packages" class="table table-striped table-bordered text-nowrap w-100">
											<thead class="thead-light">												
												...
												<th  class="text-center">Subidas</th>
											...
											@foreach($profile as $data)
												...
												<?php 	$from_date = \Carbon\Carbon::createFromFormat('Y-m-d', $data->from_date);
													...
													<td>{{ $data->seen_daily }}</td>													
													<td>
														{{  date('d-m-Y', strtotime($data->from_date)) }}/{{  date('d-m-Y', strtotime($data->to_date)) }}
														</td>
													<td>
													<a target="_blank"  data-toggle="tooltip" data-original-title="History" class="btn btn-sm btn-primary" href="{{url('/admin/auto_subidas_anuncios/view/')}}/{{$data->top_subidaId}}" ><i class="fa fa-search"></i> History</a>	
