                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
							...
							<a href="{{ url('/admin/categories') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-arrow-left"></i> Back</a>                            
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form  action="{{url('/admin/categories/edit/')}}/{{$categories->id}}" enctype="multipart/form-data" method="post" class="form-material m-t-40">
								@csrf
