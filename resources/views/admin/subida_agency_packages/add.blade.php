				   ...
				   <!-- PAGE-HEADER -->
					<div class="page-header">
						...
						<ol class="breadcrumb">
							 ...
							 <li class="breadcrumb-item"><a href="{{ url('/admin/subida-agency-packages') }}">Top Agency Packages</a></li>                                
					...
					<!-- ROW-1 OPEN -->
						...
						<div class="row">
					<div class="col-lg-12">
							 <form action="{{ action('Admin\SubidaAgencyPackagesController@add')}}" enctype="multipart/form-data" method="post" class="card">
								@csrf							
								<div class="card-header">
									<h3 class="card-title">Add Subida Agency Packages</h3>
								</div>
								<div class="card-body">
									<div class="row">
