					...
					<div class="page-header">
						...
						<ol class="breadcrumb">
							 <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Home</a></li>
                                <li class="breadcrumb-item active">Subida Agency Packages</li>
					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							...
							<div class="card">
								...
								<form  action="{{ action('Admin\SubidaAgencyPackagesController@index')}}" enctype="multipart/form-data" method="get" >
									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												...
												<a style="   width: 100%;" href="{{ url('/admin/subida-agency-packages/add') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add Subida Agency Packages</a> 
											</div>
										</div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="packages" class="table table-striped table-bordered text-nowrap w-100">
											...
											<tbody>
												<?php $i=1; ?> 
												@foreach($subida_agency_packages as $data)
												<tr>
													...
													<td>{{ $data->price }}</td>
													<td>
													<a  data-toggle="tooltip" data-original-title="Edit" class="btn btn-sm btn-primary" href="{{url('/admin/subida-agency-packages/edit/')}}/{{$data->id}}" ><i class="fa fa-edit"></i> Edit</a>							
													<?php /*<a  data-id="{{$data->id}}"  data-location="subida-agency-packages"    href="#" data-toggle="tooltip" data-original-title="Delete" class="btn btn-sm btn-danger sa-params"  ><i class="fa fa-trash"></i> Delete</a>*/?>
													</td>
