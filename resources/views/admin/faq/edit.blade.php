				...
				<div class="container content-area relative">
				   ...
				   <!-- PAGE-HEADER -->
					...
					<!-- ROW-1 OPEN -->
						...
						<div class="row">
					<div class="col-lg-12">
							 <form action="{{url('/admin/faq/edit/')}}/{{$faq->id}}" enctype="multipart/form-data" method="post" class="card">
								@csrf							
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input value="{{$faq->question}}" type="text" name="question" class="form-control">
										...
										<div class="col-md-12">
											<div class="form-group">
												<textarea class="form-control content" name="answer" id="summernote" >{{$faq->answer}}</textarea>												
