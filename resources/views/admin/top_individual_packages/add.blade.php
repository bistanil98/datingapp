				...
				<div class="container content-area relative">
				   ...
				   <!-- PAGE-HEADER -->
					...
					<!-- ROW-1 OPEN -->
						...
						<div class="row">
					<div class="col-lg-12">
							 <form action="{{ action('Admin\TopIndividualPackagesController@add')}}" enctype="multipart/form-data" method="post" class="card">
								@csrf							
								<div class="card-header">
									<h3 class="card-title">Add Top Individual Packages</h3>
								</div>
								<div class="card-body">
									<div class="row">
