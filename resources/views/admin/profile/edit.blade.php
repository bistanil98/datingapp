														...
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	<input title="Obligatorio" required value="@if(!empty($edit_tariffs0)) {{$edit_tariffs0['tariffs_description']}} @endif" name="tariffs_description[]" type="text" class="form-control" >
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
