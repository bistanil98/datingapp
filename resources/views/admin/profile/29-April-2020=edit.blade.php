											...
											<div class="Horario-input common-right">
												...
												<div class="row" id="schedule">
													...
													<div class="col-md-6">
														...
														<div class="row select-row">
															<div class="col-md-4 col-lg-3 offset-lg-1  select-column label-column">
													...
													<div class="col-md-12 col-lg-8 col-sm-12">
														...
														<div class="row select-row">
															<div class="col-md-12 col-lg-4 col-6  col-sm-12 select-column label-column">
																<input <?php if(!empty($edit_schedule) && $edit_schedule['days']==$data){ echo 'checked';}?> type="checkbox" value="{{$data}}" id="defaultCheck" name="days[]" style="vertical-align: middle;">
															...
															<div class="col-md-4 col-lg-2 col-6 col-sm-4 select-column2">
																<select name="from_1[]" class="custom-select cus-select mb-3">
																		<option></option>
																		<?php foreach($schedule_from_1 as $data){ ?>
																			<option <?php if(!empty($edit_schedule) && $edit_schedule['from_1']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																		<?php } ?>
																	</select>
															</div>
															<div class="col-md-4 col-lg-2 col-6 col-sm-4 select-column2">
																<select name="from_2[]" class="custom-select cus-select mb-3">
																		<option></option>
																		<?php foreach($schedule_from_2 as $data){ ?>
																			<option <?php if(!empty($edit_schedule) && $edit_schedule['from_2']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																		<?php } ?>
																	</select>
															</div>
														</div>  
														...
														<div class="row select-row">
															...
															<div class="col-md-4 col-lg-4 col-6 col-sm-4 select-column2">
																<select name="unit_1[]" class="custom-select cus-select mb-3">
																		<option></option>
																		<?php foreach($schedule_from_1 as $data){ ?>
																			<option <?php if(!empty($edit_schedule) && $edit_schedule['unit_1']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																		<?php } ?>
																	</select>
															</div>
															<div class="col-md-4 col-lg-4 col-6 col-sm-4 select-column2">
																<select name="unit_2[]" class="custom-select cus-select mb-3">
																		<option></option>
																		<?php foreach($schedule_from_2 as $data){ ?>
																			<option <?php if(!empty($edit_schedule) && $edit_schedule['unit_2']==$data){ echo 'selected';}?> value="{{$data}}">{{$data}}</option>
																		<?php } ?>
																	</select>
															</div>
														</div>  
