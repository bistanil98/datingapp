...
<div class="container content-area relative">
	...
	<div class="row">
		<div class="col-lg-12">
			<form  id="profile-ads"  method="post" action="{{url('/admin/profile/add/')}}/{{$category}}" enctype="multipart/form-data">
				@csrf
								...
								<div class="col-md-6">
									<div class="left-registration">
										<div class="main-image-register">
											...
											<span style="   color: white;   font-weight: 700;">La imagen de perfil debe tener un mínima de 400 px</span>
									...
									<div class="right-registration">
										<div class="profile-register-div common-right">
											...
											<div class="row">
												<div class="form-group col-md-4">
													<select readonly name="category" class="custom-select">
										...
										<div class="profile-register-div detos-heading common-right">
											...
											<div class="row">
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														<div class="col-md-4 left-justify"><label for="Edad">Population</label></div>
														<div class="col-md-8 left-justify">
										...
										<div class="profile-register-div common-right">
											...
											<div class="row">
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														<div class="col-md-5 left-justify"><label for="Edad">Escoja Edad </label></div>
														<div class="col-md-7 left-justify">
