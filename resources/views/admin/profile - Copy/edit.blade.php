										...
										<div class="left-registration">
											<div class="main-image-register">
												<div class="top-cover-img">
													...
													<?php $profile =  profile_photo($profile_ads->id); ?>
													<input data-default-file="<?php if(!empty($profile)){  echo URL::asset('public/uploads/profile_ads/'.$profile); }?>" type="file" name="profile" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												...
												<div class="row">	
														...
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	...
																	<input value="<?php if (array_key_exists('0', $profile_tariffs)) { echo $profile_tariffs[0]->tariffs_description; }?>" name="tariffs_description[]" type="text" class="form-control"  placeholder="{{ __('registration.description_placeholder')}}">
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
																	<label for="usr">{{ __('registration.price')}}</label>
																	<input value="<?php if (array_key_exists('0', $profile_tariffs)) { echo $profile_tariffs[0]->tariffs_euro_price; }?>" name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-12">	
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	<input value="<?php if (array_key_exists('1', $profile_tariffs)) { echo $profile_tariffs[1]->tariffs_description; }?>" name="tariffs_description[]" type="text" class="form-control" >
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
																	<input value="<?php if (array_key_exists('1', $profile_tariffs)) { echo $profile_tariffs[1]->tariffs_euro_price; }?>" name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
															</div>
														</div>
													</div>
												...
												<div class="row collapse" id="addmore">
													<div class="col-md-12">	
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	<input value="<?php if (array_key_exists('2', $profile_tariffs)) { echo $profile_tariffs[2]->tariffs_description; }?>" name="tariffs_description[]" type="text" class="form-control" >
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
																	<input value="<?php if (array_key_exists('2', $profile_tariffs)) { echo $profile_tariffs[2]->tariffs_euro_price; }?>" name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-12">	
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	<input value="<?php if (array_key_exists('3', $profile_tariffs)) { echo $profile_tariffs[3]->tariffs_description; }?>" name="tariffs_description[]" type="text" class="form-control" >
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
																	<input value="<?php if (array_key_exists('3', $profile_tariffs)) { echo $profile_tariffs[3]->tariffs_euro_price; }?>" name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-12">	
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	<input value="<?php if (array_key_exists('4', $profile_tariffs)) { echo $profile_tariffs[4]->tariffs_description; }?>" name="tariffs_description[]" type="text" class="form-control" >
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
																	<input value="<?php if (array_key_exists('4', $profile_tariffs)) { echo $profile_tariffs[4]->tariffs_euro_price; }?>" name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="form-group col-md-4">
														...
														<?php foreach($categories as $data){?>
															<option <?php if($data->name==$profile_ads->category){ echo 'selected'; }?> value="{{$data->name}}">{{$data->name}}</option>
															<?php }?>
														</select>
													</div>
												</div>
														...
														<div class="row">
															...
															<select name="population" class="custom-select" id="population" required>
																...
																<?php foreach($population as $data){?>
																	<option <?php if($data->name==$profile_ads->population){ echo 'selected'; }?> value="{{$data->id}}">{{$data->name}}</option>
																<?php }?>
															</select>
															</div>
										...
										<div class="photos-div">
											...
											<div class="row">
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if (array_key_exists('0', $gallery_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$gallery_photo[0]->upload_file); }?>" type="file" name="gallery[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if (array_key_exists('1', $gallery_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$gallery_photo[1]->upload_file); }?>" type="file" name="gallery[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if (array_key_exists('2', $gallery_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$gallery_photo[2]->upload_file); }?>" type="file" name="gallery[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if (array_key_exists('3', $gallery_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$gallery_photo[3]->upload_file); }?>" type="file" name="gallery[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
											<div class="row " >
												<div class="collapse col-md-12" id="phtosss">
													<div class="row">
														<div class="col-md-3 imgUp">
															<input data-default-file="<?php if (array_key_exists('4', $gallery_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$gallery_photo[4]->upload_file); }?>" type="file" name="gallery[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input data-default-file="<?php if (array_key_exists('5', $gallery_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$gallery_photo[5]->upload_file); }?>" type="file" name="gallery[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input data-default-file="<?php if (array_key_exists('6', $gallery_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$gallery_photo[6]->upload_file); }?>" type="file" name="gallery[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input data-default-file="<?php if (array_key_exists('7', $gallery_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$gallery_photo[7]->upload_file); }?>" type="file" name="gallery[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div></div>
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												...
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if (array_key_exists('0', $selfie_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$selfie_photo[0]->upload_file); }?>"  type="file" name="selfie[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if (array_key_exists('1', $selfie_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$selfie_photo[1]->upload_file); }?>" type="file" name="selfie[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if (array_key_exists('2', $selfie_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$selfie_photo[2]->upload_file); }?>" type="file" name="selfie[]" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if (array_key_exists('3', $selfie_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$selfie_photo[3]->upload_file); }?>" type="file" name="selfie[]"  accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
										...
										<div class="photos-div">
											...
											<div class="row">
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if (array_key_exists('0', $videos_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$videos_photo[0]->upload_file); }?>" type="file" name="videos[]" accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if (array_key_exists('1', $videos_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$videos_photo[1]->upload_file); }?>" type="file" name="videos[]"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if (array_key_exists('2', $videos_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$videos_photo[2]->upload_file); }?>"  type="file" name="videos[]"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if (array_key_exists('3', $videos_photo)) {  echo URL::asset('public/uploads/profile_ads/'.$videos_photo[3]->upload_file); }?>" type="file" name="videos[]"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
