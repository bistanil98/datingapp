...
<div class="container">
        ...
        <div class="row">
            <div class="col-6"><!--left side -->
                <div class="form-group row">
                    <label for="fname" class="col-sm-4 col-form-label"><h6><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Agency Category</font></font></h6></label>
                    <div class="col-sm-8">                        
		 ...
		 <div class="row">
		   ...
		   <div class="col-6">
            ...
            <div class="col-6"><!--left side -->
                ...
                <div class="form-group row">
                    <label for="fname" class="col-sm-4 col-form-label"><h6>Zona</h6></label>
                    <div class="col-sm-8">
