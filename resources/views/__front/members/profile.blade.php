										...
										<div class="photos-div">
											...
											<div class="row">
												<div class="col-md-3 imgUp">
													<input type="file" name="pic1" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input type="file" name="pic2" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp">
													<input type="file" name="pic3" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input type="file" name="pic4" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
											<div class="row " >
												<div class="collapse col-md-12" id="phtosss">
													<div class="row">
														<div class="col-md-3 imgUp">
															<input type="file" name="pic5" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input type="file" name="pic6" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input type="file" name="pic7" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input type="file" name="pic8" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div></div>
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												...
												<div class="col-md-3 imgUp">
													<input type="file" name="selfie1" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input type="file" name="selfie2" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp">
													<input type="file" name="selfie3" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input type="file" name="selfie4"  accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
										...
										<div class="photos-div">
											...
											<div class="row">
												<div class="col-md-3 imgUp video">
													<input type="file" name="video1" accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input type="file" name="video2"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input type="file" name="video3"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input type="file" name="video4"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
							...
							<?php }else{?>
										...
										<div class="left-registration">
											<div class="main-image-register">
												<div class="top-cover-img">
													...
													<input data-default-file="<?php if(!empty($profile_ads->profile_pic)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->profile_pic); }?>" type="file" name="profile" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
											...
											<div class="tarifs-input common-left">
												<div class="row">	
													<div class="col-md-12">	
														<h4>Tarifas</h4>
														<?php $edit_tariffs0 = edit_tariffs($profile_ads->id,$nunber=0);?>
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	<input value="@if(!empty($edit_tariffs0)) {{$edit_tariffs0['tariffs_description']}} @endif" name="tariffs_description[]" type="text" class="form-control" >
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
																	<input value="@if(!empty($edit_tariffs0)) {{$edit_tariffs0['tariffs_euro_price']}} @endif" name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
															</div>
														</div>
													</div>
													...
													<div class="col-md-12">	
													<?php $edit_tariffs1 = edit_tariffs($profile_ads->id,$nunber=1);?>
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
												...
												<div class="row collapse" id="addmore">
													<div class="col-md-12">	
													<?php $edit_tariffs2 = edit_tariffs($profile_ads->id,$nunber=2);?>
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
													...
													<div class="col-md-12">	
													<?php $edit_tariffs3 = edit_tariffs($profile_ads->id,$nunber=3);?>
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
													...
													<div class="col-md-12">	
													<?php $edit_tariffs4 = edit_tariffs($profile_ads->id,$nunber=4);?>
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
									...
									<div class="col-md-6 rigt-main-column">
										<div class="right-registration">
											<div class="profile-register-div common-right">
												...
												<form>
													<div class="row">
														<div class="form-group col-md-12">
															<input value="{{$profile_ads->first_name}}" type="text" name="first_name" required class="form-control" placeholder="Name">
														</div>
													</div>
												</form>
											</div>
											<div class="profile-register-div common-right">
												<div class="tekephone-tooptip">	
													...
													<div class="row">
														<div class="form-group col-md-6">
															<input value="{{$profile_ads->telephone}}" type="text" name="telephone" class="form-control"  placeholder="telephone" required onkeypress="return isNumberKey(event)">
														</div>
														<div class="form-group verify-button col-md-6 ">
															<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal-verify">Verify</button>
														</div>
												...
												<div class="row">
													...
													<div class="col-md-6 justifty-profile">
														<div class="row">
															...
															<div class="col-md-7 left-justify">
																<div class="form-group">
																	<input value="{{$profile_ads->zone}}" type="text" name="zone" value="" class="form-control" placeholder="Select a Zone">
																</div>															
															</div>
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														...
														<select name="age" class="custom-select" required>
															...
															<?php
															for($foot=15;$foot<=60;$foot++){ ?>															
																<option <?php if($foot==$profile_ads->age){ echo 'selected'; }?> value='{{$foot}}'> {{$foot}} Years </option>																									
															<?php }	?>
														</select>
														</div>
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														...
														<select name="height" class="custom-select" required>
															...
															for($inches=0;$inches<=11;$inches++){
															if($inches==0){ ?>
															<option <?php if($foot.' feet'==$profile_ads->height){ echo 'selected'; }?> value='{{$foot}} feet'> {{$foot}} feet </option>	
															<?php }else{ ?>
															<option <?php if($foot.' feet'.' '.$inches.' inches'==$profile_ads->height){ echo 'selected'; }?> value='{{$foot}} feet {{$inches}} inches'> {{$foot}} feet {{$inches}} inches </option>															
														<?php 	}
															}
															}
															?>
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														...
														<select name="chest" class="custom-select" required>
															...
															<?php
															for($foot=30;$foot<=150;$foot++){		?>													
																<option <?php if($foot==$profile_ads->chest){ echo 'selected'; }?> value='{{$foot}} Inches'> {{$foot}} Inches </option>																									
														<?php 	}
															?>															
														</select>
														</div>
										...
										<div class="description-regis detos-heading common-right">
											...
											<div class="form-group">
												<label for="comment"><h4>Text</h4></label>
												<textarea name="text" class="form-control" rows="3" >{{$profile_ads->text}}</textarea>
											</div> 
										</div>
								...
								<div class="col-md-12" id="photoss">
									<div class="main-uploding-div common-div">
										<div class="photos-div">
											...
											<div class="row">
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if(!empty($profile_ads->gallery_1)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->gallery_1); }?>"   type="file" name="pic1" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if(!empty($profile_ads->gallery_2)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->gallery_2); }?>" type="file" name="pic2" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if(!empty($profile_ads->gallery_3)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->gallery_3); }?>"type="file" name="pic3" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if(!empty($profile_ads->gallery_4)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->gallery_4); }?>" type="file" name="pic4" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
											<div class="row " >
												<div class="collapse col-md-12" id="phtosss">
													<div class="row">
														<div class="col-md-3 imgUp">
															<input data-default-file="<?php if(!empty($profile_ads->gallery_5)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->gallery_5); }?>" type="file" name="pic5" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input data-default-file="<?php if(!empty($profile_ads->gallery_6)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->gallery_6); }?>" type="file" name="pic6" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input data-default-file="<?php if(!empty($profile_ads->gallery_7)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->gallery_7); }?>" type="file" name="pic7" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div>
														<div class="col-md-3 imgUp">
															<input data-default-file="<?php if(!empty($profile_ads->gallery_8)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->gallery_8); }?>" type="file" name="pic8" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
														</div></div>
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												...
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if(!empty($profile_ads->selfie_1)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->selfie_1); }?>" type="file" name="selfie1" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if(!empty($profile_ads->selfie_2)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->selfie_2); }?>" type="file" name="selfie2" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if(!empty($profile_ads->selfie_3)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->selfie_3); }?>" type="file" name="selfie3" accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
												
												<div class="col-md-3 imgUp">
													<input data-default-file="<?php if(!empty($profile_ads->selfie_4)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->selfie_4); }?>" type="file" name="selfie4"  accept='image/*'  data-allowed-file-extensions="png jpg jpeg" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
									...
									<div class="main-uploding-div common-div" id="videoss">
										<div class="photos-div">
											...
											<div class="row">
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if(!empty($profile_ads->video_1)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->video_1); }?>" type="file" name="video1" accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if(!empty($profile_ads->video_2)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->video_2); }?>" type="file" name="video2"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if(!empty($profile_ads->video_3)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->video_3); }?>"  type="file" name="video3"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if(!empty($profile_ads->video_4)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->video_4); }?>" type="file" name="video4"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf" data-allowed-formats="portrait square" class="dropify">
												</div>
											</div>
								...
								<div class="col-md-6">
									<div class="Sobreti-div common-div">
										...
										<?php foreach($over_you as $over_you_data){?>
											<div class="col-md-6 tag-column">
												<div class="form-group">
													<?php $checkover_you = checkover_you($over_you_data->name);?>
								...
								<div class="col-md-6">
									<div class="Sobreti-div common-div">
										...
										<div class="row">
											...
											<div class="col-md-6 tag-column">
												<div class="form-group">
													<?php $check_services = check_services($services_data->name);?>
