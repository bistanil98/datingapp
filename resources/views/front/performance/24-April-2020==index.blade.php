...
<div class="col-md-3">
    <div class="graf-coldiv tb-graph">
      ...
      <span class="column-text"><h4>€ {{piesepuertoTotalTop($id)}} <!-- <br> --> <span class="subtext">Top Anuncio </span></h4></span>
      <span class="column-text"><h4>€ {{piesepuertoTotalSubida($id)}} <!-- <br> --> <span class="subtext">  Auto Subida</span></h4></span>
      </div>
