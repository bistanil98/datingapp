...
<div class="col-md-3">
    <div class="graf-coldiv tb-graph">
      ...
      <span class="column-text"><h4>€ {{piesepuertoTotal($id)}} <!-- <br> --> <span class="subtext">Presupuesto</span></h4></span>
      <span class="column-text"><h4>{{registrationAfterActiveTopAnuncio($id)}}<!--€ {{piesepuertoTotalTop($id)}}--> <!-- <br> --> <span class="subtext">Top Anuncio </span></h4></span>
      <span class="column-text"><h4>{{registrationAfterGoneAutoSubida($id)}}<!--€ {{piesepuertoTotalSubida($id)}}--> <!-- <br> --> <span class="subtext">  Auto Subida</span></h4></span>
      </div>
     ...
     <div class="col-md-9">
       <div class="graf-bg">
           ...
           $province = createSlug(province($ads->province));
												...
												$title = createSlug(($ads->title));
												$category = (($ads->category));
												$id = (($ads->id));
												$url = url('profile/'.$category.'/'.$province.'/'.$population.'/'.$title.'/'.$id);
												?>
        <a href="<?php echo $url;?>">
         <span class="graf-img">
...
<div class="row">
  <div class="col-md-3">
    <div class="graf-coldiv cardoneones">
      <span class="heading" style="margin: 0;"><h4>Visualizaciones <a style="color:#fff;" href="#" data-toggle="tooltip" data-placement="top" title="Lotem Ipsum Lotem Ipsum Lotem Ipsum Lotem Ipsum">
  ...
  <div class="col-md-3">
    <div class="graf-coldiv">
      <span class="heading" style="margin: 0;"><h4>Presupuesto <a style="color:#fff;" href="#" data-toggle="tooltip" data-placement="top" title="Lotem Ipsum Lotem Ipsum Lotem Ipsum Lotem Ipsum">
													<span class="icons"><i class="fas fa-question-circle"></i></span>
												</a></h4></span>
     <?php /* <h3 style="color: #fff;    font-weight: 400;
  ...
  <div class="col-md-3">
    <div class="graf-coldiv">
       <span class="heading" style="margin: 0;"><h4>Top Anuncio <a style="color:#fff;" href="#" data-toggle="tooltip" data-placement="top" title="Lotem Ipsum Lotem Ipsum Lotem Ipsum Lotem Ipsum">
													<span class="icons"><i class="fas fa-question-circle"></i></span>
												</a></h4></span>
      <?php /*<h3 style="color: #fff;    font-weight: 400;
  ...
  <div class="col-md-3">
    <div class="graf-coldiv">
      <span class="heading" style="margin: 0;"><h4>Auto Subida <a style="color:#fff;" href="#" data-toggle="tooltip" data-placement="top" title="Lotem Ipsum Lotem Ipsum Lotem Ipsum Lotem Ipsum">
													<span class="icons"><i class="fas fa-question-circle"></i></span>
												</a></h4></span>
    <?php /*  <h3 style="color: #fff;    font-weight: 400;
...
#### CSS ####
.google-visualization-tooltip {  padding: 1px !important; font-size:15px; border :0px !important;} 
.google-visualization-tooltip-item-list { padding: 0px !important;  margin:1px !important; border :0px !important;}
.google-visualization-tooltip-item      { overflow:hidden; max-width:210px !important;
height:20px !important; padding: 0px !important;    margin:1px !important; font-size:10px;   white-space:nowrap;}
.google-visualization-tooltip-item span:nth-child(2) { display:inline-block; width:100px
!important; text-align:center !important; }
.google-visualization-tooltip-item span:nth-child(3) { display:inline-block; width:30px
!important; text-align:center !important; background-color:white;};
#anuncio_estadisticas_top g rect {
			...
			<div class="row">
				<div class="col-md-10 col-lg-11 col-8">
					<div class="subida-header text-center">
						<h3><strong>No hay anuncio grafico</strong></h3>
					</div>
				</div>
			</div>
		</div>
