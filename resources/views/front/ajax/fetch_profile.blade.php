...
<div class="popupclick-button">
	...
	<button <?php /*data-id="{{$top_previous_profile}}" */?>  class="btn btn-danger left arrow-left"><i class="fas fa-arrow-left"></i> </button>
	
	<?php //} ?>
	
	<?php //if(!empty($top_next_profile)){?>
	
	<button <?php /*data-id="{{$top_next_profile}}"*/?> class="btn btn-danger right arrow-right"><i class="fas fa-arrow-right"></i> </button>
					...
					<div id="anuncio_productos"><h4 style="text-transform:none !important;">Estadísticas de este anuncio</h4> 
						...
						<div class="Estadísticas ">
							<ul class="listado-ul">
								...
								<li>
									<label>
										<span class="maintag">€ <strong>{{piesepuertoTotal($profile_ads_id)}}</strong></span> <span class="simpleg">Presupuesto </span>
									</label>
								</li>
								<li>
									<label>
										<!--<span class="maintag">€ <strong>{{piesepuertoTotalTop($profile_ads_id)}} / --><span class="maintag"><strong>{{registrationAfterActiveTopAnuncio($profile_ads_id)}}</strong></span> <span class="simpleg">Top Anuncios</span>
									</label>
								</li>
								<li>
									<label>
										<!--<span class="maintag">€ <strong>{{piesepuertoTotalSubida($profile_ads_id)}} / --><span class="maintag"><strong>{{registrationAfterGoneAutoSubida($profile_ads_id)}}</strong></span> <span class="simpleg">Auto Subida</span>
									</label>
								</li>
		...
		<div class="col-md-6">
			...
			<div class="right-main-popup">
				...
				<div class="girl-detais-div common-div">
					...
					<div class="contact-link" id="target">
...
<script>
  ...
  $("#girl_modals").scroll(function () {
  	console.log($(window).scrollTop());
    $('#target').css(
      $("#girl_modals").scrollTop() > 200
        ? { 'position': 'fixed', 'top': '-31px','right': '0','left': '600px','z-index':9999 }
