			...
			<div class="main-div-popup">
				...
				<div class="graf-img-main common-left">
					...
					<div id="anuncio_productos"><h4>Estadísticas de este anuncio</h4> 
						...
						<span id="estadisticas_ver_mas" class="onclick enlace_antiguo" data-src="/estadisticas/8xwbj"><a href="{{url('/estadisticas/'.$data->id.'')}}" class="btn btn-primary"> ver más </a>
			...
			<div class="right-main-popup">
				...
				<?php if(!empty($data->tariffs)){?>
					<div class="price-list common-div">
						<div class="price big">
							<h4>Tariffs</h4>
				<?php foreach(json_decode($data->tariffs) as $tariffs){?><h6><span>{{$tariffs->tariffs_description}}</span> <span>{{$tariffs->tariffs_euro_price}} €</span></h6><?php }?>
						</div>
					</div>
				<?php } ?>
