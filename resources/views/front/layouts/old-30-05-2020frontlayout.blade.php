...
<html lang="en">
	...
	<?php if(isset($category) && !empty($category)){ ?>
		<title><?php echo (seo($category)->title); ?></title>		
		<meta name="title" content="<?php echo (seo($category)->meta_title); ?>" />
		<meta name="description" content="<?php echo (seo($category)->meta_description); ?>" />
	<?php }else{?>
	<title></title>		
					...
					<?php //action="{{ action('SearchController@index')}}" ?>
						<form autocomplete="off" class="form-inline" name="topsearch" method="post" action="javascript:void(0)" >
							...
							<div class="input-group ">
								...
								<input value="<?php if(isset($location) && !empty($location)){ echo $location;}?>" autocomplete="off" id="geocomplete" name="location" type="text" class="form-control" placeholder="¿Dónde estás?">
							...
							<div class="input-group ">
								...
								<input id="keywords" value="<?php if(isset($keywords) && !empty($keywords)){ echo $keywords;}?>" name="keywords" type="text" class="form-control filtro" placeholder="¿Qué buscas?">
									...
									<li class="main-li"><a href="#"><i class="fas fa-list"></i></a>
										...
										<ul class="sub-li">
											...
											<?php if(!empty(session('agency_id'))){?>
												...
												<li><a   href="{{ url('/agencia-logout') }}">Cerrar Sección</a></li>	
												...
												<li><a   href="{{ url('/logout') }}">Cerrar Sección</a></li>	
									...
									<ul class="search-ulmain">
										...
										<li class="search-mainli">
											...
											<div class="nav-icons">
												...
												<input value="<?php if(isset($keywords) && !empty($keywords)){ echo $keywords;}?>" name="keywords" type="hidden" >
												<input value="<?php if (isset($agenciaId) &&!empty($agenciaId)){ echo $agenciaId;}?>" name="agenciaId" type="hidden" >

												<input value="<?php if(isset($location) && !empty($location)){ echo $location;}?>"  name="location" type="hidden" >
											...
											<ul id="pelo" class="sublist-ul horiyo-ul apariencia-ul">
												...
												<li class="sublist-li horiyo-price range-price pelo-li"><label><span>Pelo</span></label>
													...
													<li class="sublist-li firstcheckbox pelo-checkbox">
														...
														<label><input type="checkbox" name="hair[]" value="Rubio"> <span>Rubio
													...
													<li class="sublist-li firstcheckbox pelo-checkbox">
														...
														<label><input type="checkbox" name="hair[]" value="Moreno"> <span>Moreno</span></label>
													...
													<li class="sublist-li firstcheckbox pelo-checkbox">
														...
														<label><input type="checkbox" name="hair[]" value="Peli Rojo"> <span>Peli Rojo
													...
													<li class="sublist-li firstcheckbox pelo-checkbox">
														...
														<label><input type="checkbox" name="hair[]" value="Castaño"> <span>Castaño
...
<?php if(Route::getCurrentRoute()->getActionName()!='App\Http\Controllers\AgencyController@register_agencia'){?>
	<script type="text/javascript">
		...
		var category = $("#category").val();
			...
			var top_ads_list_out  = $('#top_ads_list_out').val();	
			var subida_ads_list_out  = $('#subida_ads_list_out').val();				
			if(top_ads_list_out==''){			
				$('.top-fix-button h2').css({"display": "none"});
				if(subida_ads_list_out!=''){	
					$('.top-fix-button h2').text('Auto Subida');
					$('.top-fix-button h2').css({"display": "block"});
				}
			}else if(subida_ads_list_out==''){	
				//$('.top-fix-button h2').css({"display": "none"});
			}else{
				if(top_ads_list_out!=''){	
...
<?php }?>
	...
	<script type="text/javascript">
		...
		if(category !='' && geocomplete !='' && keywords !=''){
			window.location = APP_URL+'/'+category+'/'+geocomplete+'/'+keywords;
		}else if(category !='' && geocomplete !=''){
			window.location = APP_URL+'/'+category+'/'+geocomplete;
		}else if(category !=''){
