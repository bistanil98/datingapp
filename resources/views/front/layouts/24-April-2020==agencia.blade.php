		...
		<header>
			<nav class="navbar navbar-expand-lg  bg-light navbar-light listing-bar list-barss">
				<div class="container-fluid">
					...
					<?php } ?>
					<?php if(Route::getCurrentRoute()->getActionMethod()=='anuncios' || Route::getCurrentRoute()->getActionMethod()=='zona_top' || Route::getCurrentRoute()->getActionMethod()=='subida_zone' && !empty(session('user_id'))){ ?>
                    <div class="regis-header">
                    <h5><a  href="{{url('/members/control')}}" class="das-subanchor active">Panel de control</a></h5>
                    </div>
