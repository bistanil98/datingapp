    ...
    <h4>paso 2</h4>
      ...
      <div class="col-md-10 col-lg-11 col-8">
        <div class="subida-header">
          <h3><span class="subida-head-span">Haga clic en los anuncios que desse subir a zona Top Anuncio</span></h3>
        </div>
      </div>
    </div><!-- row -->
...
<div class="row  img-row card-row">
  ...
  <div class="col-md-10 col-lg-11 col-8">
    <div class="peso-text">
      <h5>Elija el numero de semanas que desee anunciarse</h5>
    </div>
  </div>
  <div class="col-md-11 offset-sm-1">
  ...
  <div class="col-md-3 col-sm-6">
   <label class="card-text-lab">
    ...
    <div class="card-vale card-blue card-pink card-input">
      <h5 class="blue-recom">Precio Total</h5>
	...
	var numberOfChecked = $('.image-checkbox input:checkbox:checked').length;
			...
			$.ajax({
					...
					$('.euro').text('euros');
						...
						//alert(response);
						$('.base_price').html(response/numberOfChecked);
