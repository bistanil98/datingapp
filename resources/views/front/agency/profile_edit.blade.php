...
<?php  require app_path()."/constant/profile_values.php";?>
		...
		<form  id="profile-ads"  method="post"   action="{{url('/agencia/crear-anuncio-update')}}/{{$profile_ads->id}}/{{$location}}" enctype="multipart/form-data">
			 @csrf
							...
							<div class="main-registration">
									...
									<div class="col-md-6">
										<div class="left-registration">
											<div class="main-image-register">
												...
												<div style="color: #fff; font-weight: 700;text-align:center">La imagen de perfil debe tener un mínima de 400 px</div>
												...
												<div class="row">	
													<div class="col-md-12">	
														...
														<div class="row">
															...
															<div class="col-md-5">
																<div class="form-group">
																	<input title="Obligatorio" required value="@if(!empty($edit_tariffs0)) {{$edit_tariffs0['tariffs_euro_price']}} @endif" name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
																</div>
														</div>
													</div>
											...
											<div class="Horario-input common-right">
												...
												<?php if($profile_ads->schedule_status=='no'){?>
													...
													<?php $i = 0;foreach($days as $data){ ?>
														...
														<?php $get_schedule_update0 = get_schedule_update_2($profile_ads->id,$data);?>
												<div class="row">
												...
												<div class="row">
													<div class="form-group col-md-4">
														...
														foreach($categoriesSaved as $categorydata){?>	
															<option <?php if(strtolower($categorydata)==$profile_ads->category){ echo 'selected'; }?> value="{{strtolower($categorydata)}}">{{$categorydata}}</option>
														<?php }?>
											...
											<div class="profile-register-div detos-heading common-right">
												...
												<div class="row">
													...
													<div class="col-md-6 justifty-profile">
														<div class="row">
															<div class="col-md-4 left-justify"><label for="Edad">Provincia</label></div>
															<div class="col-md-8 left-justify">
													...
													<div class="col-md-6 justifty-profile">
														<div class="row">
															<div class="col-md-4 left-justify"><label for="Edad">Poblacion</label></div>
															<div class="col-md-8 left-justify">
													...
													<div class="col-md-6 justifty-profile">
														<div class="row">
															<div class="col-md-4 left-justify"><label for="Edad">Zona   <span class="zona-span">(Opcional)</span></label></div>
															<div class="col-md-8 left-justify">
																<div class="form-group">
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														...
														<select name="age" class="custom-select" required>
															<option value="">Escoja Edad</option>
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														...
														<select name="height" class="custom-select" required>
															...
															<option <?php if($height==$profile_ads->height){ echo 'selected'; }?> value='{{$height}} cm'>{{$height}} cm</option>
															<?php } ?>
														</select>
														</div>
													...
													<div class="row">
														...
														<select name="weight" class="custom-select" required>
															...
															for($foot=40;$foot<=150;$foot++){		?>													
																<option <?php if($foot==$profile_ads->weight){ echo 'selected'; }?> value='{{$foot}}'> {{$foot}} kg </option>																									
														<?php 	}
															?>		
														</select>
														</div>
								...
								<div class="col-md-12" id="photoss">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="photo-check">
														<a href="#" class="btn btn-primary" data-toggle="collapse" data-target="#phtosss">Añadir Titulo fotos</a>
													</div>
												</div>
											</div>
											<!---------------- Selfie------------------>	
									...
									<div class="main-uploding-div common-div" id="videoss">
										<div class="photos-div">
											<h4>Vídeos</h4>
											<p class="photo-p2">No están permitidos: videos con marcas de agua</p>
											
											<div class="row">
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if(!empty($profile_ads->video_1)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->video_1); }?>" type="file" name="video1" accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf 3gp mkv"  class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if(!empty($profile_ads->video_2)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->video_2); }?>" type="file" name="video2"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf 3gp mkv"  class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if(!empty($profile_ads->video_3)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->video_3); }?>"  type="file" name="video3"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf 3gp mkv"  class="dropify">
												</div>
												<div class="col-md-3 imgUp video">
													<input data-default-file="<?php if(!empty($profile_ads->video_4)){  echo URL::asset('public/uploads/profile_ads/'.$profile_ads->video_4); }?>" type="file" name="video4"  accept='video/*'  data-allowed-file-extensions="mp4 x-m4v flv mpg mpeg swf 3gp mkv"  class="dropify">
												</div>
											</div>
...
drEvent.on('dropify.error.imageFormat', function(event, element){
    alert('La imagen de perfil debe tener un mínima de 400 px');
});
...
$("select[name='category']").change(function(){
 ...
 <script type='text/javascript'>
	...
	function service_over(SelectCategory){
		 $.ajaxSetup({
          headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          }
      ...
      $.ajax({
       url: APP_URL+'/ajax/service_over' ,
        type: "POST",
        data: {SelectCategory:SelectCategory},
        success: function( response ) {					
				$('#service_over').empty();		
				$('#service_over').append(response);		
        },
      });
