														...
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	...
																	<input required value="1 hour" name="tariffs_description[]" type="text" class="form-control"  placeholder="{{ __('registration.description_placeholder')}}">
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
									...
									<div class="col-md-6 rigt-main-column">
												...
												<div class="col-md-6 justifty-profile">
													<div class="row">
														...
														<select name="age" class="custom-select" required>
															<option value="">Select Edad</option>
															<?php
										...
										<div class="description-regis detos-heading common-right">
											<div class="form-group short-from">
												...
												<a href="#" data-toggle="tooltip" data-placement="top" title="Este texto saldrá en el pie de la foto publicada en la página principal de Escort Listing">?</a>
												</label>
									...
									<div class="col-md-12">
										<div class="submit-from">
											...
											<button id="continue" type="submit" class="btn btn-danger">
												Publicar anuncio and add more  <i class="fa fa-caret-right"></i>
											</button>
										</div>
