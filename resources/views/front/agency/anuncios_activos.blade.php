 ...
 <div class="row border-card-row subida-ads">
   <div class="col-md-12 auto-subida-column">
      <div class="image-text-heading heading-two hed_01  text-center">
        <h5 style="text-transform: inherit !important;">Anuncios Contratados en Auto Subida</h5>
      </div>
    </div>
	   ...
	   <div class="col-md-8 col-lg-6">
        <div class="left-image-text-main green_01">
          ...
          <div class="left-image-text">
            ...
            <h5>Subidas Diarias :  <span class="labl-txt">{{$check_top_subida_profile_lists->seen_days}}</span></h5>
			<h5>Dias Contratados : <span class="labl-txt">{{$check_top_subida_profile_lists->seen_days}} dias</span></h5>
	...
	<div class="row border-card-row top-ads" style="display: flex !important;">
	 <div class="col-md-12">
      <div class="image-text-heading heading-two hed_01  text-center">
        <h5 style="text-transform: inherit !important;">Anuncios Contratados en Zona Top</h5>
      </div>
    </div>
