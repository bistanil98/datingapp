...
<?php  require app_path()."/constant/profile_values.php";?>
	...
	<body>
		...
		<section class="registration-sec">
			...
			<form  id="profile-ads"  method="post" action="{{ action('AgencyController@profile')}}" enctype="multipart/form-data">
				@csrf
			 <input name="location" id="location" type="hidden" value="discontinue">
										...
										<div class="left-registration">
											<div class="main-image-register">
												<div class="top-cover-img">
													...
													<input data-allowed-formats="portrait" data-min-height="400"  required type="file" name="profile" accept='image/*'  data-allowed-file-extensions="png jpg jpeg"   class="dropify">
												</div>
														...
														<div class="row">
															<div class="col-md-7">
																<div class="form-group">
																	...
																	<input required value="1 hora" name="tariffs_description[]" type="text" class="form-control"  placeholder="{{ __('registration.description_placeholder')}}">
																</div>
															</div>
															<div class="col-md-5">
																<div class="form-group">
																	<label for="usr">{{ __('registration.price')}}</label>
																	<input title="Obligatorio" required name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
															</div>
														</div>
													</div>
											...
											<div class="Horario-input common-right">
												...
												<div class="row">
													<div class="col-md-12 col-lg-8 col-sm-12">
														...
														<div class="row select-row">
															<div class="col-md-12 col-lg-5 col-6  col-sm-12 select-column label-column">
													...
													<div class="col-md-12 col-lg-4 col-sm-12">
														...
														<div class="row select-row">
															<div class="col-md-4 col-lg-4 col-sm-4 select-column label-column">
															<label for="">Hasta las</label></div>
									...
									<div class="col-md-6 rigt-main-column">
												...
												<div class="row">
													<div class="form-group col-md-4">
														...
														foreach($categoriesSaved as $categorydata){?>	
															<option  value="{{strtolower($categorydata)}}">{{$categorydata}}</option>
														<?php }?>
														</select>
													</div>
												</div>
												...
												<form>
													<div class="row">
														<div class="form-group col-md-12">
															<input type="text" name="first_name" required class="form-control" placeholder="Nombre">
														</div>
													</div>
												</form>
											</div>
												...
												<div class="tekephone-tooptip">	
													...
													<div class="row">
														<div class="form-group col-md-6">
															<input type="text" name="telephone" class="form-control"  placeholder="Telefono" required onkeypress="return isNumberKey(event)">
														</div>
												...
												<div class="row">
													...
													<div class="col-md-6 justifty-profile">
														<div class="row">
															...
															<div class="col-md-8 left-justify">
																<div class="form-group">
																	<input type="text" name="zone" value="" class="form-control" placeholder="Escoja una Zona">
																</div>															
															</div>
													...
													<div class="row">
														...
														<select name="age" class="custom-select" required>
															...
															for($foot=18;$foot<=60;$foot++){ ?>															
																<option value='{{$foot}}'> {{$foot}} a&ntilde;os</option>																									
															<?php }	?>
														</select>
														</div>
										...
										<div class="description-regis detos-heading common-right">
											<div class="form-group short-from">
												...
												<a href="#" data-toggle="tooltip" data-placement="top" title="Test Este texto saldrá en el pie de la foto publicada en la página principal de Escort Listing">?</a>
												</label>
								...
								<div class="col-md-12">
									...
									<div class="col-md-12">
										<div class="submit-from">
											<button type="submit" id="discontinue" class="btn btn-danger">
												Publicar anuncio  <i class="fa fa-caret-right"></i>
											</button>
											
											<button id="continue" type="submit" class="btn btn-danger">
												Publicar anuncio y seguir añadiendo  <i class="fa fa-caret-right"></i>
											</button>
										</div>
...
drEvent.on('dropify.error.fileFormat', function(event, element){
    alert('portrait format error message!');
});
		</script>
		<script type="text/javascript">
			/* function show(){
...
<script>
	$('#discontinue').click(function(){
		$('#location').val('discontinue');
	});
	$('#continue').click(function(){
		$('#location').val('continue');
	});
</script>
<script>
$("select[name='category']").change(function(){
 ...
 <script type='text/javascript'>
    ...
    <script>
	var SelectCategory = $("select[name='category']").find(":selected").text();
	service_over(SelectCategory);
