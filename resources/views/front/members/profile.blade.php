	...
	<body>
		...
		<section class="registration-sec">
			<div class="regis-main-header">	
				...
				<div class="navbar-brand regis-header" style="font-size: 24px;font-weight: 400;">Completa el formulario</div>
				...
				<div class="dasbuttons">
						...
						<a href="{{url('/members/contrasena')}}" class="btn btn-success" style="background-color:#28a745 !important; border-color:#28a745 !important;">Contraseña</a>
							...
							<div class="main-registration">
														...
														<div class="row">
															...
															<div class="col-md-5">
																<div class="form-group">
																	...
																	<input required name="tariffs_euro_price[]" title="Obligatorio" type="text" class="form-control" >
																</div>
															</div>
														</div>
													</div>
								...
								<div class="col-md-12">
									...
									<div class="map-div common-div">
										<div class="photos-div">
											<h4 class="clientes">Experiencias de tus clientes <a href="#" data-toggle="tooltip" data-placement="top" title="Este texto saldrá en el pie de la foto publicada en la página principal de Escort Listing">?</a></h4>
