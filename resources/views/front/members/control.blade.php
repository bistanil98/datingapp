					...
					<div class="col-md-12">
						...
						<div class="listing-div">
							<div class="row">
								...
								<div class="col-md-4">
									   <a href="{{url('members/consumo')}}">
										<div class="listing-icon-text icon-5">
											<?php //if(check_top_subida_profile_lists_sub($ads_id)){?>
												<?php /* <div class="fontawosme-div"><a href="{{ url('/members/estadisticas/'.$ads_id.'') }}"><span>Consumo</span></a></div> */?>
												<div class="fontawosme-div"><span>Consumo</span></div> 
											<?php //}else{ ?>
