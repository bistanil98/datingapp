		...
		<section class="registration-sec">
			<div class="regis-main-header">	
				...
				<div class="dasbuttons">
						<a  href="{{url('/members/control')}}" class="btn btn-success" style="background-color:#000 !important; border-color:#000 !important;">Panel de control</a>
												...
												<div class="row">	
													<div class="col-md-12">	
														...
														<div class="row">
															...
															<div class="col-md-5">
																<div class="form-group">
																	<input required value="@if(!empty($edit_tariffs0)) {{$edit_tariffs0['tariffs_euro_price']}} @endif" title="Obligatorio" name="tariffs_euro_price[]" type="text" class="form-control" >
																</div>
																</div>
														</div>
													</div>
