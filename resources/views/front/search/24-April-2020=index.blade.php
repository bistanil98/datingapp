						...
						<div class="item video-image grid-item">
							...
							<a href="#">
								...
								<div class="head-title-0">
									<a href="#" data-toggle="tooltip" title="{{province($data->province)}}" class="btn btn-dark">{{substr(province($data->province), 0, 6)}}</a>
						...
						<div  class="item video-image grid-item">
							<a href="javascript:void(0);"  >
								...
								<div class="img-text white-bg">
									<a href="#" data-toggle="tooltip" title="{{province($data2->province)}}" class="btn btn-dark">{{substr(province($data2->province), 0, 6)}}</a>
				...
				<!---------------------------------------------------Goning and free ads------>	
					...
					<?php $subida_increment=1;
						...
						<div class="item video-image grid-item">
							<a href="javascript:void(0);"  >
								<div class="img-top">
									<img onclick="openpopup({{$data3->id}}, {{$data3->top_subida_profile_listsID}}, 'subida')" src="<?php echo URL::asset('public/uploads/profile_ads/'.$data3->profile_pic);?>" class="img-fluid" alt="">
									<div class="overlay">
										<div class="text">
								...
								<div class="img-text white-bg">
									<a href="#" data-toggle="tooltip" title="{{province($data3->province)}}" class="btn btn-dark">{{substr(province($data3->province), 0, 6)}}</a>
