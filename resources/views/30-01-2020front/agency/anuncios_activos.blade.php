      ...
      <div class="col-md-6">
        <div class="left-image-text-main">
          ...
          <div class="left-image-text">
            ...
            <a href="{{url('agencia/zona-top/'.$free->category.'/'.$free->id.'/'.$free->province.'')}}" class="btn btn-danger"><i class="fas fa-arrow-circle-up"></i> Top Zona</a>
           </div>
          </div>
        </div>
      </div><!-- col-md-6 -->
	   ...
	   <div class="col-md-6">
        <div class="left-image-text-main green_01">
          ...
          <div class="left-image-text">
           ...
           <a href="{{url('agencia/zona-top/'.$subida->category.'/'.$subida->id.'/'.$subida->province.'')}}" class="btn btn-danger"><i class="fas fa-arrow-circle-up"></i> Top Zona</a>
